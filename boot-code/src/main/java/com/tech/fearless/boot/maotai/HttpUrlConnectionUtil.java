...
public class HttpUrlConnectionUtil {
    ...
    public static ArrayList<String> ips() throws IOException {
        String path = "http://api.xiequ.cn/VAD/GetIp.aspx?act=get&uid=67776&vkey=5749F60052273EBAC1196365D622369A&num=5&time=30&plat=1&re=0&type=0&so=1&ow=1&spl=1&addr=&db=1";// 要获得html页面内容的地址
